(function clientCode(){
  ...
  function renderDemo(){
    ...
    root.innerHTML = `<header class="preview-bar"><a class="preview-brand" href="./index.html" aria-label="Arabix shop"><img src="./assets/logo-white.png" alt="Arabix" /></a><div class="preview-meta"><strong>${productTitle(p)}</strong><span>${externalUrl ? 'Arabix hosted preview wrapper' : t('demoTag')}</span></div><nav class="preview-actions" aria-label="Preview actions"><a class="preview-details" href="./theme.html?slug=${p.slug}">${t('details')}</a><a class="preview-buy" href="./theme.html?slug=${p.slug}">${t('buyNow')}</a></nav></header><section class="demo-stage ${externalUrl ? 'demo-stage--frame' : ''}">${previewBody}</section>`;
  }
  function rerender(){
